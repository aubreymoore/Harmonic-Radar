...
\subsection{Ancillary experiments}

\subsubsection{Maximum detection distances for each of the 3 RECCO transceivers we used}

See \href{https://osf.io/9f4mb}{Jupyter notebook} for details.


\subsubsection{Maximum detection distances for single and doouble tagged CRB}

See \href{https://osf.io/2ypgk}{Jupyter notebook} for details.


\subsubsection{Attenuation of maximum detection distances when targets are buried in coir}

See \href{https://osf.io/zheqm}{Jupyter notebook} for details.
