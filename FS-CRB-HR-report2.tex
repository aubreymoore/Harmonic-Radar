...
\begin{itemize}
	\item Used digital recordings of the RECCO's audio output to locate tags (Technical report)
	\item Flown the RECCO harmonic radar to a drone (Fig. \ref{fig:drone})
\end{itemize}
}
